...
Usage:
    ...
    python src/data_collection_scripts/collect_all.py usdt --start 2020-01-01
    python src/data_collection_scripts/collect_all.py all --no-coinapi      # skip CoinAPI index if key not ready
